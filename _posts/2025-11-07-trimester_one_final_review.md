...
<table> 
    ...
    <tr>
        <td>Using Objects and Methods</td>
        <td>75%</td>
    </tr>
    <tr>
        <td>Selection and Iteration</td>
        <td>69%</td>
    </tr>
    <tr>
...
1. First review the documentation on how the syntax workings of Java for and while loops
2. Make exercises that utilizes for and while loops (example: matrices)
3. Complete those exercises by creating the necessary for and while loops
4. Predict, before running the code, how the output will be displayed to get that practice internalizing how loops work
5. Run the code and see if my predictions were correct
6. If not, understand why and note it down
